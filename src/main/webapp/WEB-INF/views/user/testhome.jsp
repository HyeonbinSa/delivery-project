...
<style>
	...
	<div class="category-list container-fluid">
		<div class="row">
			...
			<div class="category-item col-xs-6 col-sm-4 col-md-3">
				<div class="category-content" style="background-image:url('/images/category-02.png')" onclick="location.href='/user/list/프랜차이즈'">
					<p class="category-title">프랜차이즈</p>
				</div>
			</div>
			<div class="category-item col-xs-6 col-sm-4 col-md-3">
				<div class="category-content" style="background-image:url('/images/category-03.png')" onclick="location.href='/user/list/치킨'">
					<p class="category-title">치킨</p>
				</div>
			</div>
			<div class="category-item col-xs-6 col-sm-4 col-md-3">
				<div class="category-content" style="background-image:url('/images/category-04.png')" onclick="location.href='/user/list/피자양식'">
					<p class="category-title">피자/양식</p>
				</div>
			</div>
			<div class="category-item col-xs-6 col-sm-4 col-md-3">
				<div class="category-content" style="background-image:url('/images/category-05.png')" onclick="location.href='/user/list/중국집'">
					<p class="category-title">중국집</p>
				</div>
			</div>
			<div class="category-item col-xs-6 col-sm-4 col-md-3">
				<div class="category-content" style="background-image:url('/images/category-06.png')" onclick="location.href='/user/list/한식'">
					<p class="category-title">한식</p>
				</div>
			</div>
			<div class="category-item col-xs-6 col-sm-4 col-md-3">
				<div class="category-content" style="background-image:url('/images/category-07.png')" onclick="location.href='/user/list/일식돈까스'">
					<p class="category-title">일식/돈까스</p>
				</div>
			</div>
			<div class="category-item col-xs-6 col-sm-4 col-md-3">
				<div class="category-content" style="background-image:url('/images/category-08.png')" onclick="location.href='/user/list/족발보쌈'">
					<p class="category-title">족발/보쌈</p>
				</div>
			</div>
			<div class="category-item col-xs-6 col-sm-4 col-md-3">
				<div class="category-content" style="background-image:url('/images/category-09.png')" onclick="location.href='/user/list/야식'">
					<p class="category-title">야식</p>
				</div>
			</div>
			<div class="category-item col-xs-6 col-sm-4 col-md-3">
				<div class="category-content" style="background-image:url('/images/category-10.png')" onclick="location.href='/user/list/분식'">
