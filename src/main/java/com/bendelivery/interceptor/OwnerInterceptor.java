...
public class OwnerInterceptor extends HandlerInterceptorAdapter{
	private static final Logger logger = LoggerFactory.getLogger(OwnerInterceptor.class);
	private static final String LOGIN ="owner_login";
	// 로그인 이전에 이용하던 경로를 저장
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
			...
			if(session.getAttribute("owner_role") != "OWNER") {
